    ...
    return (
        <div>               
            ...
            <Link className='link' style={{zIndex: 1, width:"100%",textAlign:"left", marginLeft:"5vw",
                    ...
                    href={"/"}>← Go Back</Link>
                <img src={("/Images/Projects/Vulkouch/Vulkouch_screenshot.png")} style={{borderRadius:"40px", width: "600px"}} />
                <h1>Vulkouch</h1>
                <PointLight left={70} top={80} backgroundColor={"var(--grey)"}/>
                <PointLight left={30} top={60} backgroundColor={"var(--grey)"}/>
                <PointLight left={-20} top={90} backgroundColor={"var(--grey)"}/>
                <PointLight left={50} top={120} backgroundColor={"var(--grey)"}/>
